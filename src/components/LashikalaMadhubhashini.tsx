...
const experience = [
  {
    ...
    company: "The Blue Water Hotel & Spa, Wadduwa",
    description:
...
const education = [
  ...
  },
  {
    ...
    institution: "G/Dharmasoka College",
    icon: GraduationCap,
  },
  {
    year: "2007",
    title: "GCE Ordinary Level",
    institution: "G/Ananda Central College",
    icon: GraduationCap,
  },
];
          ...
          <div className="grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
            ...
            <div>
              ...
              >
                Lashikala
                <br />
                <span className="text-[#9a7650]">Madhubhashini</span>
              </motion.h1>
              ...
              >
                ...
                <a
                  href="mailto:rsithu201615@gmail.com"
